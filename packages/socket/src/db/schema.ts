...
// Inlined as a string constant so it survives esbuild bundling to CJS
// (no import.meta.url / no runtime file lookup). Applied idempotently
// by the migration runner in db/index.ts.
